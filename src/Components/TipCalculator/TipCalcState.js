...
import { Alert, Form, Col, Row, Label, Button, Card, CardBody, CardTitle, CardText, Input, UncontrolledDropdown, DropdownToggle, DropdownMenu, DropdownItem } from 'reactstrap';
                        ...
                        <Form >
                            ...
                            <Card style={{ padding: '2rem', fontSize: '12pt', fontWeight: 'bold' }}>
                                <Col>
                                    ...
                                    <Input type="numbers" name="totalBill" value={totalBill} placeholder="Enter Total Bill ($)" onChange={this.handleFormChange} />
